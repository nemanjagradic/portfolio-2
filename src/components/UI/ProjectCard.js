...
const ProjectCard = ({
  ...
  return (
    <div className="group mb-10 mt-6 h-full w-full overflow-hidden text-center sm:mb-0 sm:p-5">
      ...
      >
        <div
          className={`relative w-full overflow-hidden before:absolute before:left-0 before:top-0 before:z-10 before:h-full before:w-full before:bg-[var(--accent-40)] before:opacity-0 before:transition-all before:duration-300 before:content-[''] group-hover:before:opacity-100`}
        >
